...
class OrderLists extends Component {
  ...
  constructor(){
    ...
    const haveLists = (list.length > 0) ? true:false
    ...
    if(haveLists){
      ...
      lists = <div className="txt_emty">ยังไม่มีรายการที่เลือก</div>
    }
                  ...
                  <CardBody >
                    ...
                    <Row>
                      <Col style={{ fontSize: '15px' }}>
                        <p>
                          {haveLists && `${address.addr && address.addr} ต.${address.sub_district} อ.${address.district} จ.${address.province} ${address.postcode} `}
                        </p>
                      </Col>
                    </Row>
                    <Row>
